...
from screens.startScreen import disp_text
...
def theme_screen(screen, clock, scr_width, scr_height, music_paused):
    ...
    while True:
        ...
        for xy in pos_of_boxes:
            ...
            pygame.draw.rect(screen, WHITE, (xy[0], xy[1], 300, 150), 2)  # rect border
            pygame.draw.circle(screen, WHITE, (xy[0] + 150, xy[1] + 75), 30, 2)  # middle circle
            pygame.draw.line(screen, WHITE, (xy[0] + 150, xy[1]), (xy[0] + 150, xy[1] + 150), 2)  # middle line
            pygame.draw.rect(screen, WHITE, (xy[0], xy[1] + 30, 50, 95), 2)  # left small rect
            pygame.draw.rect(screen, WHITE, (xy[0] + 300 - 50, xy[1] + 30, 50, 95), 2)  # right small rect
            i = i + 1
